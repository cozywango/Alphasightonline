        ...
        <AnimatedSection>
          <div className="text-center mb-12">
            <motion.h1 initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.2 }} className="text-hero mb-4">
              Investor <span className="text-gradient-orange">Decks</span>
            </motion.h1>
        ...
        <AnimatedSection>
          <div className="glass-card glow-orange rounded-3xl p-8 md:p-10">
            <div className="flex items-start gap-6">
              <div className="glow-badge shrink-0"><FileText size={28} /></div>
              <div>
                ...
                <Link to="/contact"><GradientButton>Fix My Deck</GradientButton></Link>
              </div>
            </div>
          </div>
        </AnimatedSection>
