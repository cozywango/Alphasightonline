  ...
  return (
    <div className="min-h-screen py-24">
      <div className="container mx-auto px-6">
        ...
        <AnimatedSection>
          <div className="text-center mb-20">
            <h1 className="text-hero mb-8">
              Refining the <span className="text-gradient-orange">Lens</span> of Authority
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <AnimatedSection>
              ...
              <div className="space-y-6 text-lg leading-relaxed text-muted-foreground">
                ...
                <div className="pl-6 border-l-2 border-primary my-8 py-2" style={{ boxShadow: '-2px 0 12px rgba(255,138,0,0.1)' }}>
            ...
            <AnimatedSection delay={0.2}>
              <div className="grid grid-cols-2 gap-6">
                ...
                <div className="glass-card glass-card-blue p-8 rounded-2xl">
                  <Users className="text-[#0094ff] mb-4" size={32} />
                  <h3 className="text-xl font-bold mb-1">Capped</h3>
                  <p className="text-sm text-muted-foreground">Client list by design</p>
                </div>
                <div className="glass-card glass-card-blue p-8 rounded-2xl">
                  <Globe className="text-[#0094ff] mb-4" size={32} />
        ...
        <section className="mb-32">
          <AnimatedSection>
            <h2 className="bracket-title mb-16">The Core</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <div className="glass-card glow-orange rounded-3xl p-12">
                <h3 className="text-3xl font-bold mb-6 flex items-center gap-3">
                  <span className="w-8 h-1 bg-primary rounded-full" style={{ boxShadow: '0 0 8px rgba(255,138,0,0.5)' }} /> Vision
                </h3>
              ...
              <div className="glass-card glow-blue rounded-3xl p-12">
                <h3 className="text-3xl font-bold mb-6 flex items-center gap-3">
                  <span className="w-8 h-1 bg-[#0094ff] rounded-full" style={{ boxShadow: '0 0 8px rgba(0,148,255,0.5)' }} /> Mission
                </h3>
                <p className="text-lg leading-relaxed text-muted-foreground mb-4">
        ...
        <section className="mb-32">
          <AnimatedSection>
            <div className="text-center mb-16">
              <h2 className="bracket-title mb-6">What We Deliver</h2>
            ...
            <div className="glass-card rounded-3xl p-12">
              <div className="grid md:grid-cols-3 gap-12">
                <div className="text-center group">
                  <div className="glow-badge mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                    01
                  </div>
                ...
                <div className="text-center group">
                  <div className="glow-badge-blue mx-auto mb-6 group-hover:scale-110 transition-transform duration-300">
                    03
                  </div>
        ...
        <section>
          <AnimatedSection>
            <div className="text-center mb-16">
              <h2 className="bracket-title mb-6">Our Operating Code</h2>
              <p className="text-subtitle max-w-2xl mx-auto">
