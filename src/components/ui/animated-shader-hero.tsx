            ...
            <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white">
                ...
                <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
                    ...
                    <div className="space-y-2">
                        <h1
                            className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-orange-300 via-yellow-400 to-amber-300 bg-clip-text text-transparent opacity-0 animate-[fade-in-up_0.8s_ease-out_0.2s_forwards]"
                        >
                            {headline.line1}
                        </h1>
                        <h1
                            className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-yellow-300 via-orange-400 to-red-400 bg-clip-text text-transparent opacity-0 animate-[fade-in-up_0.8s_ease-out_0.4s_forwards]"
                        >
                            {headline.line2}
                        </h1>
                    </div>
                    ...
                    {/* Subtitle */}
                    <div className="max-w-3xl mx-auto opacity-0 animate-[fade-in-up_0.8s_ease-out_0.6s_forwards]">
                    ...
                    {/* CTA Buttons */}
                    {buttons && (
                        <div className="flex flex-col sm:flex-row gap-4 justify-center mt-10 opacity-0 animate-[fade-in-up_0.8s_ease-out_0.8s_forwards]">
                            {buttons.primary && (
                                <button
                    ...
                    {/* Additional children (e.g., custom content below buttons) */}
                    {children}
                </div>
            </div>
        </div>
