  ...
  ({ image, title, delay, isVisible, index, totalCount, onClick, isSelected }, ref) => {
    ...
    return (
      ...
      >
        <div
          className={cn(
            'w-full h-full rounded-lg overflow-hidden shadow-xl bg-card border border-border relative',
        ...
        >
          ...
          <p className="absolute bottom-1.5 left-1.5 right-1.5 text-[9px] font-black uppercase tracking-tighter text-foreground truncate drop-shadow-md">
            {title}
          </p>
        </div>
      </div>
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={cn(
          'absolute top-6 right-6 z-50 w-12 h-12 flex items-center justify-center rounded-full bg-card/30 backdrop-blur-xl border border-border shadow-2xl text-foreground hover:bg-card transition-all duration-300'
        )}
        style={{
      ...
      <button
        ...
        className={cn(
          'absolute left-4 md:left-10 z-50 w-14 h-14 flex items-center justify-center rounded-full bg-card/30 backdrop-blur-xl border border-border text-foreground hover:scale-110 active:scale-95 transition-all duration-300 disabled:opacity-0 disabled:pointer-events-none shadow-2xl'
        )}
        style={{
      ...
      <button
        ...
        className={cn(
          'absolute right-4 md:right-10 z-50 w-14 h-14 flex items-center justify-center rounded-full bg-card/30 backdrop-blur-xl border border-border text-foreground hover:scale-110 active:scale-95 transition-all duration-300 disabled:opacity-0 disabled:pointer-events-none shadow-2xl'
        )}
        style={{
      ...
      >
        <div className={cn('relative overflow-hidden rounded-[inherit] bg-card border border-border shadow-[0_35px_60px_-15px_rgba(0,0,0,0.5)]')}>
          ...
          <div
            className={cn('px-8 py-7 bg-card border-t border-border')}
            style={{
              opacity: animationPhase === 'complete' && !isClosing ? 1 : 0,
    ...
    <>
      ...
      >
        ...
        <div className="relative flex items-center justify-center mb-4" style={{ height: '160px', width: '200px' }}>
          <div className="absolute w-32 h-24 rounded-lg shadow-md border border-border" style={{ background: backBg, filter: gradient ? 'brightness(0.9)' : 'none', transformOrigin: 'bottom center', transform: isHovered ? 'rotateX(-20deg) scaleY(1.05)' : 'rotateX(0deg) scaleY(1)', transition: 'transform 700ms cubic-bezier(0.16, 1, 0.3, 1)', zIndex: 10 }} />
          <div className="absolute w-12 h-4 rounded-t-md border-t border-x border-border" style={{ background: tabBg, filter: gradient ? 'brightness(0.85)' : 'none', top: 'calc(50% - 48px - 12px)', left: 'calc(50% - 64px + 16px)', transformOrigin: 'bottom center', transform: isHovered ? 'rotateX(-30deg) translateY(-3px)' : 'rotateX(0deg) translateY(0)', transition: 'transform 700ms cubic-bezier(0.16, 1, 0.3, 1)', zIndex: 10 }} />
          ...
          <div className="absolute w-32 h-24 rounded-lg shadow-lg border border-border" style={{ background: frontBg, top: 'calc(50% - 48px + 4px)', transformOrigin: 'bottom center', transform: isHovered ? 'rotateX(35deg) translateY(12px)' : 'rotateX(0deg) translateY(0)', transition: 'transform 700ms cubic-bezier(0.16, 1, 0.3, 1)', zIndex: 30 }} />
